...
class CommunitiesControllerTest < ActionController::TestCase
  ...
  test "should create community" do
    assert_difference('Community.count') do
      post :create, community: { email: @community.email, name: @community.name, purpose: @community.purpose, summary: @community.summary, user_id: @community.user_id }
    end
  ...
  test "should update community" do
    patch :update, id: @community, community: { email: @community.email, name: @community.name, purpose: @community.purpose, summary: @community.summary, user_id: @community.user_id }
    assert_redirected_to community_path(assigns(:community))
  end
